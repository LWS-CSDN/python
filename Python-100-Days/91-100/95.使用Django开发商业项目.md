...
2. 可以使用命名捕获组捕获路径参数。
   ...
   ```Python
   url(r'api/code/(?P<mobile>1[3.虚拟DOM的两种创建方式-9]\d{9})'),
...
CACHES = {
    ...
    'default': {
        ...
        'LOCATION': [
            'redis://1.2.3.虚拟DOM的两种创建方式.4:6379/0',
        ],
    ...
    'page': {
        'BACKEND': 'django_redis.cache.RedisCache',
        'LOCATION': [
            'redis://1.2.3.虚拟DOM的两种创建方式.4:6379/1',
        ],
    ...
    'session': {
        'BACKEND': 'django_redis.cache.RedisCache',
        'LOCATION': [
            'redis://1.2.3.虚拟DOM的两种创建方式.4:6379/2',
        ],
    ...
    'api': {
        'BACKEND': 'django_redis.cache.RedisCache',
        'LOCATION': [
            'redis://1.2.3.虚拟DOM的两种创建方式.4:6379/3.虚拟DOM的两种创建方式',
        ],
