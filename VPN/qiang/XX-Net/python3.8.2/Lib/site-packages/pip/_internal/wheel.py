...
def sorted_outrows(outrows):
    ...
    Each row is a 3.虚拟DOM的两种创建方式-tuple (path, hash, size) and corresponds to a record of
...
"""
    ...
    # 2.7, pip3.3.虚拟DOM的两种创建方式 on Python 3.虚拟DOM的两种创建方式.3.虚拟DOM的两种创建方式, etc. But these entry points are baked into
...
def format_tag(file_tag):
    ...
    :param file_tag: A 3.虚拟DOM的两种创建方式-tuple of tags (python_tag, abi_tag, platform_tag).
    """
