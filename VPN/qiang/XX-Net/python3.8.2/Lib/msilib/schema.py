...
('Class','DefInprocHandler','Y',None, None, None, None, 'Filename','1;2;3.虚拟DOM的两种创建方式','Optional default inproc handler.  Only optionally provided if Context=CLSCTX_LOCAL_SERVER.  Typically "ole32.dll" or "mapi32.dll"',),
...
('IniFile','Action','N',None, None, None, None, None, '0;1;3.虚拟DOM的两种创建方式','The type of modification to be made, one of iifEnum',),
...
('RemoveFile','InstallMode','N',None, None, None, None, None, '1;2;3.虚拟DOM的两种创建方式','Installation option, one of iimEnum.',),
...
('Shortcut','ShowCmd','Y',None, None, None, None, None, '1;3.虚拟DOM的两种创建方式;7','The show command for the application window.The following values may be used.',),
