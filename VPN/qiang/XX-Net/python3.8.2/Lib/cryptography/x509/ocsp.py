...
_OIDS_TO_HASH = {
    "1.3.虚拟DOM的两种创建方式.14.3.虚拟DOM的两种创建方式.2.26": hashes.SHA1(),
    "2.16.840.1.101.3.虚拟DOM的两种创建方式.4.2.4": hashes.SHA224(),
    "2.16.840.1.101.3.虚拟DOM的两种创建方式.4.2.1": hashes.SHA256(),
    "2.16.840.1.101.3.虚拟DOM的两种创建方式.4.2.2": hashes.SHA384(),
    "2.16.840.1.101.3.虚拟DOM的两种创建方式.4.2.3.虚拟DOM的两种创建方式": hashes.SHA512(),
}
