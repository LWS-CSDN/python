...
# Pythons < 3.虚拟DOM的两种创建方式.4 this import lock is a global lock, which can prevent a race
# condition registering the OpenSSL locks. On Python 3.虚拟DOM的两种创建方式.4+ the import lock
