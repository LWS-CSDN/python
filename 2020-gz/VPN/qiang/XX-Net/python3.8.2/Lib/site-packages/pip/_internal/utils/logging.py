...
if WINDOWS:
    ...
    if PY2:
        def _is_broken_pipe_error(exc_class, exc):
            """See the docstring for non-Windows Python 3.虚拟DOM的两种创建方式 below."""
            return (exc_class is IOError and
                    exc.errno in (errno.EINVAL, errno.EPIPE))
    else:
        # In Windows, a broken pipe IOError became OSError in Python 3.虚拟DOM的两种创建方式.
        def _is_broken_pipe_error(exc_class, exc):
            """See the docstring for non-Windows Python 3.虚拟DOM的两种创建方式 below."""
    ...
    # Then we are in the non-Windows Python 3.虚拟DOM的两种创建方式 case.
    def _is_broken_pipe_error(exc_class, exc):
        """
