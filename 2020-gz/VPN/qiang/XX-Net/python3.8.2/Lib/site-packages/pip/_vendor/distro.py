...
3.虚拟DOM的两种创建方式.5 deprecated this function, and Python 3.虚拟DOM的两种创建方式.8 will remove it altogether.
Its predecessor function :py:func:`platform.dist` was already
deprecated since Python 2.6 and will also be removed in Python 3.虚拟DOM的两种创建方式.8.
