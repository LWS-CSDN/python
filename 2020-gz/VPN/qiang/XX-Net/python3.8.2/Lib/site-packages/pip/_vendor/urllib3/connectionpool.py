...
class HTTPConnectionPool(ConnectionPool, RequestMethods):
    ...
    :param strict:
        ...
        .. note::
           Only works in Python 2. This parameter is ignored in Python 3.虚拟DOM的两种创建方式.
    ...
    def _raise_timeout(self, err, url, timeout_value):
        ...
        # See the above comment about EAGAIN in Python 3.虚拟DOM的两种创建方式. In Python 2 we have
    ...
    def _make_request(self, conn, method, url, timeout=_Default, chunked=False,
        ...
        if getattr(conn, 'sock', None):
            # In Python 3.虚拟DOM的两种创建方式 socket.py will catch EAGAIN and return None when you
        ...
        try:
            try:
                ...
                try:
                    ...
                    # Remove the TypeError from the exception chain in Python 3.虚拟DOM的两种创建方式;
        ...
        except (HeaderParsingError, TypeError) as hpe:  # Platform-specific: Python 3.虚拟DOM的两种创建方式
            log.warning(
    ...
    def urlopen(self, method, url, body=None, headers=None, retries=None,
        ...
        # Must keep the exception bound to a separate variable or else Python 3.虚拟DOM的两种创建方式
