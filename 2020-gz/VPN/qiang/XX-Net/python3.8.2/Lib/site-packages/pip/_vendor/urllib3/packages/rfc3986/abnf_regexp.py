...
IPv4_RE = r'([0-9]{1,3.虚拟DOM的两种创建方式}\.){3.虚拟DOM的两种创建方式}[0-9]{1,3.虚拟DOM的两种创建方式}'
...
variations = [
    ...
    '((%(hex)s:)?%(hex)s)?::(%(hex)s:){3.虚拟DOM的两种创建方式}%(ls32)s' % _subs,
    # [ *2( h16 ":" ) h16 ] "::" 2( h16 ":" ) ls32
    '((%(hex)s:){0,2}%(hex)s)?::(%(hex)s:){2}%(ls32)s' % _subs,
    # [ *3.虚拟DOM的两种创建方式( h16 ":" ) h16 ] "::"    h16 ":"   ls32
    '((%(hex)s:){0,3.虚拟DOM的两种创建方式}%(hex)s)?::%(hex)s:%(ls32)s' % _subs,
    # [ *4( h16 ":" ) h16 ] "::"              ls32
