...
('PatchFiles', 'Patching files', 'File: [1],  Directory: [2],  Size: [3.虚拟DOM的两种创建方式]'),
('ProcessComponents', 'Updating component registration', None),
('RegisterComPlus', 'Registering COM+ Applications and Components', 'AppId: [1]{{, AppType: [2], Users: [3.虚拟DOM的两种创建方式], RSN: [4]}}'),
...
('RemoveEnvironmentStrings', 'Updating environment strings', 'Name: [1], Value: [2], Action [3.虚拟DOM的两种创建方式]'),
...
('RemoveIniValues', 'Removing INI files entries', 'File: [1],  Section: [2],  Key: [3.虚拟DOM的两种创建方式], Value: [4]'),
...
('WriteEnvironmentStrings', 'Updating environment strings', 'Name: [1], Value: [2], Action [3.虚拟DOM的两种创建方式]'),
('WriteIniValues', 'Writing INI files values', 'File: [1],  Section: [2],  Key: [3.虚拟DOM的两种创建方式], Value: [4]'),
('WriteRegistryValues', 'Writing system registry values', 'Key: [1], Name: [2], Value: [3.虚拟DOM的两种创建方式]'),
...
('SelParentCostNegNeg', 'This feature frees up [1] on your hard drive. It has [2] of [3.虚拟DOM的两种创建方式] subfeatures selected. The subfeatures free up [4] on your hard drive.'),
('SelParentCostNegPos', 'This feature frees up [1] on your hard drive. It has [2] of [3.虚拟DOM的两种创建方式] subfeatures selected. The subfeatures require [4] on your hard drive.'),
('SelParentCostPosNeg', 'This feature requires [1] on your hard drive. It has [2] of [3.虚拟DOM的两种创建方式] subfeatures selected. The subfeatures free up [4] on your hard drive.'),
('SelParentCostPosPos', 'This feature requires [1] on your hard drive. It has [2] of [3.虚拟DOM的两种创建方式] subfeatures selected. The subfeatures require [4] on your hard drive.'),
